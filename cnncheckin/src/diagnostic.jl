...
function suggest_solutions()
    ...
    println("   - Verifique se 'lele' tem imagens no diretório de treinamento")
    ...
    println("\n5. 🛠️  Debug adicional:")
    println("   - Verifique se a imagem de teste realmente é da pessoa 'lele'")
    println("   - Confirme se 'lele' existe no dataset de treinamento")
end
